...
% Last Modified by GUIDE v2.5 25-Jun-2013 20:17:39
...
MaskPath = [ResultantFolder filesep 'Mean_FA_mask.nii.gz'];
cmd = ['fslmaths ' AveragePath ' -bin ' MaskPath ];
system(cmd);
disp('Generate white matter mask from average FA.');
MaskPath = [ResultantFolder filesep 'WM_mask.nii.gz'];
cmd = ['fslmaths ' AveragePath ' -thr ' num2str(WhiteMatter_FAThreshold) ' -bin ' MaskPath ];
system(cmd);
% remove tmp file
