function [ FileOut ] = g_DeterministicNetwork_FileOut_Tracking(NativeFolderPath,Option,PartitionTemplate, Prefix)
...
if ~exist([SubjectFolder filesep 'tmp'], 'dir')
    mkdir([SubjectFolder filesep 'tmp']);
end
