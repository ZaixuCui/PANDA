function varargout = PANDA_FileCopyer(varargin)
% GUI for copying files, by Zaixu Cui 
%-------------------------------------------------------------------------- 
%	Copyright(c) 2011
...
%   Last edited 
%--------------------------------------------------------------------------
% PANDA_FILECOPYER MATLAB code for PANDA_FileCopyer.fig
%      PANDA_FILECOPYER, by itself, creates a new PANDA_FILECOPYER or raises the existing
%      singleton*.
%
%      H = PANDA_FILECOPYER returns the handle to a new PANDA_FILECOPYER or the handle to
%      the existing singleton*.
%
%      PANDA_FILECOPYER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PANDA_FILECOPYER.M with the given input arguments.
%
%      PANDA_FILECOPYER('Property','Value',...) creates a new PANDA_FILECOPYER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before PANDA_FileCopyer_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to PANDA_FileCopyer_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help PANDA_FileCopyer

% Last Modified by GUIDE v2.5 30-May-2012 22:24:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @PANDA_FileCopyer_OpeningFcn, ...
                   'gui_OutputFcn',  @PANDA_FileCopyer_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before PANDA_FileCopyer is made visible.
function PANDA_FileCopyer_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to PANDA_FileCopyer (see VARARGIN)

% Choose default command line output for PANDA_FileCopyer
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes PANDA_FileCopyer wait for user response (see UIRESUME)
...
function varargout = PANDA_FileCopyer_OutputFcn(hObject, eventdata, handles) 
