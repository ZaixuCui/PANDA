function varargout = PANDA_TBSSDisplay(varargin)
% PANDA_TBSSDISPLAY MATLAB code for PANDA_TBSSDisplay.fig
%      PANDA_TBSSDISPLAY, by itself, creates a new PANDA_TBSSDISPLAY or raises the existing
%      singleton*.
%
%      H = PANDA_TBSSDISPLAY returns the handle to a new PANDA_TBSSDISPLAY or the handle to
%      the existing singleton*.
%
%      PANDA_TBSSDISPLAY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PANDA_TBSSDISPLAY.M with the given input arguments.
%
%      PANDA_TBSSDISPLAY('Property','Value',...) creates a new PANDA_TBSSDISPLAY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before PANDA_TBSSDisplay_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to PANDA_TBSSDisplay_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help PANDA_TBSSDisplay

% Last Modified by GUIDE v2.5 11-Jul-2015 20:22:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @PANDA_TBSSDisplay_OpeningFcn, ...
                   'gui_OutputFcn',  @PANDA_TBSSDisplay_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before PANDA_TBSSDisplay is made visible.
function PANDA_TBSSDisplay_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to PANDA_TBSSDisplay (see VARARGIN)

% Choose default command line output for PANDA_TBSSDisplay
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes PANDA_TBSSDisplay wait for user response (see UIRESUME)
% uiwait(handles.PANDA_TBSSDisplayFigure);
global TBSSRandomise_PThreshold;
global TBSSRandomise_SkeletonMask;
global TBSSRandomise_Underlay;
global TBSSRandomise_MeanFA;
global TBSSRandomise_MeanFASkeleton;
global TBSSDisplay_FillFlag;
TBSSRandomise_PThreshold = 0.05;
set(handles.PThreshold_Edit, 'String', '0.05');
if ~isempty(TBSSRandomise_SkeletonMask)
    [MeanSkeleton_Folder, ~, ~] = fileparts(TBSSRandomise_SkeletonMask);
    Underlay = [MeanSkeleton_Folder filesep 'mean_FA.nii.gz'];
    MeanFA = [MeanSkeleton_Folder filesep 'mean_FA.nii.gz'];
    MeanFASkeleton = [MeanSkeleton_Folder filesep 'mean_FA_skeleton.nii.gz'];
    if exist(Underlay, 'file')
        TBSSRandomise_Underlay = Underlay;
        set(handles.Underlay_Edit, 'String', TBSSRandomise_Underlay);
    end
    if exist(MeanFA, 'file')
        TBSSRandomise_MeanFA = MeanFA;
        set(handles.MeanFA_Edit, 'String', TBSSRandomise_MeanFA);
    end
    if exist(TBSSRandomise_MeanFASkeleton, 'file')
        TBSSRandomise_MeanFASkeleton = MeanFASkeleton;
        set(handles.MeanFASkeleton_Edit, 'String', TBSSRandomise_MeanFASkeleton);
    end  
end
TBSSDisplay_FillFlag = 0;
set(handles.TBSSFill_check, 'Value', 0);
set(handles.FilledImage_Edit, 'Enable', 'off');
set(handles.FilledImageButton, 'Enable', 'off');
% Set icon
SetIcon(handles);


% --- Outputs from this function are returned to the command line.
function varargout = PANDA_TBSSDisplay_OutputFcn(hObject, eventdata, handles) 
...
function PMap_Edit_Callback(hObject, eventdata, handles)
% hObject    handle to PMap_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of PMap_Edit as text
%        str2double(get(hObject,'String')) returns contents of PMap_Edit as a double
global TBSSRandomise_PMap;
set(handles.PMap_Edit, 'String', TBSSRandomise_PMap);


% --- Executes during object creation, after setting all properties.
function PMap_Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to PMap_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --- Executes on button press in PMap_Button.
function PMap_Button_Callback(hObject, eventdata, handles)
% hObject    handle to PMap_Button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global TBSSRandomise_PMap;
[PMap_FileName, PMap_ParentFolder] = uigetfile({'*.nii; *.nii.gz','P map (*.nii, *nii.gz)'},'Input p map');
if ~isnumeric(PMap_FileName)
    TBSSRandomise_PMap = [PMap_ParentFolder PMap_FileName];
    set(handles.PMap_Edit, 'String', TBSSRandomise_PMap);
end



function Underlay_Edit_Callback(hObject, eventdata, handles)
% hObject    handle to Underlay_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Underlay_Edit as text
%        str2double(get(hObject,'String')) returns contents of Underlay_Edit as a double
global TBSSRandomise_Underlay;
set(handles.Underlay_Edit, 'String', TBSSRandomise_Underlay);


% --- Executes during object creation, after setting all properties.
function Underlay_Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Underlay_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in Underlay_Button.
function Underlay_Button_Callback(hObject, eventdata, handles)
% hObject    handle to Underlay_Button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global TBSSRandomise_Underlay;
[Underlay_FileName, Underlay_ParentFolder] = uigetfile({'*.nii; *.nii.gz','Mean FA (*.nii, *nii.gz)'},'Input Mean FA');
if ~isnumeric(Underlay_FileName)
    TBSSRandomise_Underlay = [Underlay_ParentFolder Underlay_FileName];
    set(handles.Underlay_Edit, 'String', TBSSRandomise_Underlay);
end



function MeanFASkeleton_Edit_Callback(hObject, eventdata, handles)
% hObject    handle to MeanFASkeleton_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MeanFASkeleton_Edit as text
%        str2double(get(hObject,'String')) returns contents of MeanFASkeleton_Edit as a double
global TBSSRandomise_MeanFASkeleton;
set(handles.MeanFASkeleton_Edit, 'String', TBSSRandomise_MeanFASkeleton);


% --- Executes during object creation, after setting all properties.
function MeanFASkeleton_Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MeanFASkeleton_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in MeanFASkeleton_Button.
function MeanFASkeleton_Button_Callback(hObject, eventdata, handles)
% hObject    handle to MeanFASkeleton_Button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global TBSSRandomise_MeanFASkeleton;
[MeanFASkeleton_FileName, MeanFASkeleton_ParentFolder] = uigetfile({'*.nii; *.nii.gz','Mean FA skeleton (*.nii, *nii.gz)'},'Input mean FA skeleton');
if ~isnumeric(MeanFASkeleton_FileName)
    TBSSRandomise_MeanFASkeleton = [MeanFASkeleton_ParentFolder MeanFASkeleton_FileName];
    set(handles.MeanFASkeleton_Edit, 'String', TBSSRandomise_MeanFASkeleton);
end
...
global TBSSRandomise_PThreshold;
global TBSSDisplay_FillFlag;
global TBSSDisplay_FilledImage;
if ~TBSSDisplay_FillFlag
    if isempty(TBSSRandomise_PMap)
        msgbox('Please input the P map!');
    elseif isempty(TBSSRandomise_Underlay)
        msgbox('Please input the underlay image!');
    elseif isempty(TBSSRandomise_MeanFA)
        msgbox('Please input the mean FA image!');
    elseif isempty(TBSSRandomise_MeanFASkeleton)
        msgbox('Please input the mean FA skeleton image!');
    elseif isempty(TBSSRandomise_PThreshold)
        msgbox('Please input the P threshold (i.e., 0.05, 0.01)!');
    else
        disp('Start, please wait ...');
        [ParentFolder, PMap_FileName, PMap_Suffix] = fileparts(TBSSRandomise_PMap);
        if strcmp(PMap_Suffix, '.gz')
            TBSSDisplay_FilledImage = [ParentFolder filesep PMap_FileName(1:end-4) '_' strrep(num2str(TBSSRandomise_PThreshold), '.', '') '_tbssfill.nii.gz'];
            TBSS_SigIndex = [ParentFolder filesep PMap_FileName(1:end-4) '_' strrep(num2str(TBSSRandomise_PThreshold), '.', '') '_SigIndex.nii.gz'];
        else
            TBSSDisplay_FilledImage = [ParentFolder filesep PMap_FileName '_' strrep(num2str(TBSSRandomise_PThreshold), '.', '') '_tbssfill.nii.gz'];
            TBSS_SigIndex = [ParentFolder filesep PMap_FileName '_' strrep(num2str(TBSSRandomise_PThreshold), '.', '') '_SigIndex.nii.gz'];
        end
        cmd = ['tbss_fill ' TBSSRandomise_PMap ' ' num2str(1 - TBSSRandomise_PThreshold) ' ' TBSSRandomise_MeanFA ...
            ' ' TBSSDisplay_FilledImage];
        disp(cmd);
        system(cmd);
        cmd_PANDA = ['cluster -i ' TBSSRandomise_PMap ' -t ' num2str(1 - TBSSRandomise_PThreshold) ' -o ' TBSS_SigIndex];
        system(cmd_PANDA);
        cmd = ['fslview ' TBSSRandomise_Underlay ' -b 0,0.6 ' TBSSRandomise_MeanFASkeleton ' -l Green -b ' ...
            '0.2,0.7 ' TBSSDisplay_FilledImage ' -l Red-Yellow'];
        disp(cmd);
        system(cmd);
    end
else
    if isempty(TBSSRandomise_Underlay)
        msgbox('Please input the underlay image!');
    elseif isempty(TBSSRandomise_MeanFASkeleton)
        msgbox('Please input the mean FA skeleton image!');
    elseif isempty(TBSSDisplay_FilledImage)
        msgbox('Please input the filled tbss statistical image!');
    else
        cmd = ['fslview ' TBSSRandomise_Underlay ' -b 0,0.6 ' TBSSRandomise_MeanFASkeleton ' -l Green -b ' ...
            '0.2,0.7 ' TBSSDisplay_FilledImage ' -l Red-Yellow'];
        disp(cmd);
...
function PThreshold_Edit_Callback(hObject, eventdata, handles)
% hObject    handle to PThreshold_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of PThreshold_Edit as text
%        str2double(get(hObject,'String')) returns contents of PThreshold_Edit as a double
global TBSSRandomise_PThreshold;
TBSSRandomise_PThreshold_Edit = get(hObject, 'string');
TBSSRandomise_PThreshold = str2num(TBSSRandomise_PThreshold_Edit);
if isempty(TBSSRandomise_PThreshold)
    TBSSRandomise_PThreshold_Edit = '';
    set(hObject, 'string', '');
    msgbox('Please input number, (i.e., 0.05)');
end


% --- Executes during object creation, after setting all properties.
function PThreshold_Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to PThreshold_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in MeanFA_Button.
function MeanFA_Button_Callback(hObject, eventdata, handles)
% hObject    handle to MeanFA_Button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global TBSSRandomise_MeanFA;
[MeanFASkeleton_FileName, MeanFASkeleton_ParentFolder] = uigetfile({'*.nii; *.nii.gz','Mean FA (*.nii, *nii.gz)'},'Input mean FA');
if ~isnumeric(MeanFASkeleton_FileName)
    TBSSRandomise_MeanFA = [MeanFASkeleton_ParentFolder MeanFASkeleton_FileName];
    set(handles.MeanFA_Edit, 'String', TBSSRandomise_MeanFA);
end



function MeanFA_Edit_Callback(hObject, eventdata, handles)
% hObject    handle to MeanFA_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MeanFA_Edit as text
%        str2double(get(hObject,'String')) returns contents of MeanFA_Edit as a double
global TBSSRandomise_MeanFA;
set(handles.MeanFA_Edit, 'String', TBSSRandomise_MeanFA);


% --- Executes during object creation, after setting all properties.
function MeanFA_Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MeanFA_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function FilledImage_Edit_Callback(hObject, eventdata, handles)
% hObject    handle to FilledImage_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of FilledImage_Edit as text
%        str2double(get(hObject,'String')) returns contents of FilledImage_Edit as a double
global TBSSDisplay_FilledImage;
set(handles.FilledImage_Edit, 'String', TBSSDisplay_FilledImage);


% --- Executes during object creation, after setting all properties.
function FilledImage_Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to FilledImage_Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in FilledImageButton.
function FilledImageButton_Callback(hObject, eventdata, handles)
% hObject    handle to FilledImageButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global TBSSDisplay_FilledImage;
[FilledImage_FileName, FilledImage_ParentFolder] = uigetfile({'*.nii; *.nii.gz','Mean FA skeleton (*.nii, *nii.gz)'},'Input mean FA skeleton');
if ~isnumeric(FilledImage_FileName)
    TBSSDisplay_FilledImage = [FilledImage_ParentFolder FilledImage_FileName];
    set(handles.FilledImage_Edit, 'String', TBSSDisplay_FilledImage);
end


% --- Executes on button press in TBSSFill_check.
function TBSSFill_check_Callback(hObject, eventdata, handles)
% hObject    handle to TBSSFill_check (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of TBSSFill_check
global TBSSDisplay_FillFlag;
global TBSSRandomise_PMap;
global TBSSRandomise_MeanFA;
global TBSSRandomise_PThreshold;
...
if get(hObject, 'value') == 1
    TBSSDisplay_FillFlag = 1;
    set(handles.FilledImage_Edit, 'String', TBSSDisplay_FilledImage);
    set(handles.FilledImage_Edit, 'Enable', 'on');
    set(handles.FilledImageButton, 'Enable', 'on');
    set(handles.PMap_Edit, 'String', '');
    set(handles.PMap_Edit, 'Enable', 'off');
    set(handles.MeanFA_Edit, 'String', '');
    set(handles.MeanFA_Edit, 'Enable', 'off');
    set(handles.PThreshold_Edit, 'String', '');
    set(handles.PThreshold_Edit, 'Enable', 'off');
else
    TBSSDisplay_FillFlag = 0;
    set(handles.FilledImage_Edit, 'String', '');
    set(handles.FilledImage_Edit, 'Enable', 'off');
    set(handles.FilledImageButton, 'Enable', 'off');
    set(handles.PMap_Edit, 'Enable', 'on');
    set(handles.PMap_Edit, 'String', TBSSRandomise_PMap);
    set(handles.PMap_Button, 'Enable', 'on');
    set(handles.MeanFA_Edit, 'Enable', 'on');
    set(handles.MeanFA_Edit, 'String', TBSSRandomise_MeanFA);
    set(handles.MeanFA_Button, 'Enable', 'on');
    set(handles.PThreshold_Edit, 'Enable', 'on');
    set(handles.PThreshold_Edit, 'String', num2str(TBSSRandomise_PThreshold));
end
