function [ FileOut ] = g_FAnormalize2_FileOut( JobName,NiiOutputPath,NumberOfSubject_String,dtifit_Prefix )
%
...
FileOut{5} = [NiiOutputPath NumberOfSubject_String filesep 'tmp' filesep 'OutputDone' filesep JobName '.done' ];