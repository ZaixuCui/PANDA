function [ FileOut ] = g_NIIcrop_FileOut( JobName,NiiOutputPath,NumberOfSubject_String,Quantity_Of_Sequence,Cropping_Flag,RawDataResample_Flag,dtifit_Prefix )
%
...
if Cropping_Flag
    FileOut{i + 1} = [NiiOutputPath NumberOfSubject_String filesep 'native_space' filesep 'data_b0_average_crop.nii.gz' ];
    i = i + 1;
end
