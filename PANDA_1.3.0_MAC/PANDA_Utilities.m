...
% Last Modified by GUIDE v2.5 08-Jul-2015 03:48:07
...
set(handles.PANDA_LDHButton, 'TooltipString', TipStr);
...
% --- Executes on button press in OtherUtilitiesButton.
function OtherUtilitiesButton_Callback(hObject, eventdata, handles)
% hObject    handle to OtherUtilitiesButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
PANDA_MoreUtilities;
...
% --- Executes on button press in PANDA_TBSSRandomise.
function PANDA_TBSSRandomise_Callback(hObject, eventdata, handles)
% hObject    handle to PANDA_TBSSRandomise (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
PANDA_TBSSRandomise;
...
% theFig =findobj(allchild(0),'flat','Tag','PANDAOtherUtilitiesFigure');
% if ~isempty(theFig) 
%     delete(theFig);
% end
% % Close LDH figure.
...
% --- Executes on button press in PANDA_LDHButton.
function PANDA_LDHButton_Callback(hObject, eventdata, handles)
% hObject    handle to PANDA_LDHButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
PANDA_LDH;
