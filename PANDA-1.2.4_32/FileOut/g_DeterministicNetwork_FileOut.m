function [ FileOut ] = g_DeterministicNetwork_FileOut( JobName,NiiOutputPath,NumberOfSubject_String,Option,PartitionTemplate,Prefix )
...
FileOut{6} = [NiiOutputPath NumberOfSubject_String filesep 'tmp' filesep 'OutputDone' filesep JobName '.done' ];
