function [ FileOut ] = g_FiberNumMatrix_FileOut( JobName,NiiOutputPath,NumberOfSubject_String,Option,PartitionTemplate,Prefix )
...
Prefix = [Prefix Option.AngleThreshold '_' num2str(Option.MaskThresMin) '_' num2str(Option.MaskThresMax) ];
