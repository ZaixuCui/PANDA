function [ FileOut ] = g_DeterministicTracking_FileOut( NiiOutputPath,NumberOfSubject_String,Option,Prefix )
%
...
FileOut{16} = [FileOut{16} num2str(Option.AngleThreshold) '_' num2str(Option.MaskThresMin) '_' num2str(Option.MaskThresMax) ];
